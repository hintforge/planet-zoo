# Animals -- African Spurred (Sulcata) Tortoise
...
- **Real diet:** Herbivore -- grasses, succulents, hay
- **Natural social structure:** Territorial males; solitary outside Sep-Nov breeding season; burrows/aestivates
...
_source: Planet Zoo DLC research pass (P3) 2026-08-22, Wikipedia species page · capture: web_fetch · confidence: low (IUCN status contradicted across sources); medium (other real-world biology fields; in-game welfare data NOT obtained) · enemy-tier: 0 · puzzle-tier: 0 · category: mainline · spoiler: dlc:Zookeepers Animal Pack_

## Sources
- store.steampowered.com [official-pr, DLC listing]
- en.wikipedia.org/wiki/African_spurred_tortoise [editorial-en]
