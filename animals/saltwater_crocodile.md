...
**Latin:** *Crocodylus porosus* | **Continent:** Asia (secondary: Oceania) | **IUCN (in-game):** Least Concern | **Housing type:** Habitat

## Housing & environment

- **Land min / +per adult:** 210 m² / +50 m²
- **Water min:** 210 m²
- **Climb min:** 0 m²
...
- **Social type / group:** Solitary, territorial, highly aggressive; 1-2
...
**Only base-game habitat animal tagged Oceania as a secondary continent.** Known to knock primates out of trees into water with its tail. One of only two base-game crocodilian species (the other being Gharial); Nile Crocodile does not exist in Planet Zoo -- flag if a player asks about it.
...
- Fandom Category:Animals_by_Continent [community-wiki, cross-check]
