...
**Latin:** *Ailurus fulgens* | **Continent:** Asia | **IUCN (in-game):** Endangered | **Housing type:** Habitat

## Housing & environment

- **Land min / +per adult:** 220 m² / +10 m²
- **Water min:** 0 m²
- **Climb min:** 40 m²
- **Temperature range:** 0-29 degC
...
- **Social type / group:** Solitary, territorial; 1-2
- **Mixing compatibility:** None
- **Diet:** Bamboo / Maple Leaves & Bark / Fruit & Veg
- **Enrichment sample:** Forage Box, Wind Chimes
- **Sex-ratio cap:** 1 males : 1 females (mixed group) `[planetzoohelper 2026-09-17]`

## Welfare gotcha

Needs isolation/hiding spots -- an explicit welfare note distinct from most other solitary carnivores; a common new-player mistake is treating it like other social-tolerant small mammals.
