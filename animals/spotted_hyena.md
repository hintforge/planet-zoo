...
**Latin:** *Crocuta crocuta* | **Continent:** Africa | **IUCN (in-game):** Least Concern | **Housing type:** Habitat

## Housing & environment

- **Land min / +per adult:** 1162 m² / +92 m²
- **Water min:** 0 m²
- **Climb min:** 0 m²
...
- **Social type / group:** Female-dominated clans, communal den; 2-4
- **Mixing compatibility:** None
- **Diet:** Processed Meat / Whole Carcass / Whole Carcass+Bones
- **Enrichment sample:** Piñata, Bamboo Feeder, Blood Scent Marker

## Welfare gotcha

**Exception to popular perception**: formidable predators, not primarily scavengers -- an explicit myth-correction on the wiki, useful when a player asks a "aren't hyenas just scavengers" question.
