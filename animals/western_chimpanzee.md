# Animals -- Western Chimpanzee

**status:** research-integrated
**last_reconciled:** 2026-08-22

**Latin:** *Pan troglodytes verus* | **Continent:** Africa | **IUCN (in-game):** Critically Endangered | **Housing type:** Habitat
...
- **Social type / group:** Large male-philopatric groups, tool use, grooming; 5-15
- **Mixing compatibility:** Red River Hog (DLC)
- **Diet:** Monkey Chow / Fruit & Veg / Processed Meat & Live Ants
- **Enrichment sample:** Termite Mound, Tool Puzzle Feeder, Climbing Frame

## Welfare gotcha

Documented keeping hyraxes as pets in the wild -- a real-world behavioral fact, safe flavor color. 80 m² climbing minimum (shared with Bonobo).
