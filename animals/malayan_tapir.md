...
Mixing data for this species is contradicted across sources this pass (see Mixing compatibility above) -- confirmed compatible (Yes) with Binturong per the Binturong species page, despite the numeric tool showing "No."
