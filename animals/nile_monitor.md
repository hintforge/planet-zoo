# Animals -- Nile Monitor

**status:** research-integrated
**last_reconciled:** 2026-08-22

**Latin:** *Varanus niloticus* | **Continent:** Africa | **IUCN (in-game):** Least Concern | **Housing type:** Habitat

## Housing & environment

- **Land min / +per adult:** 300 m² / +25 m²
- **Water min:** 75 m²
- **Climb min:** 0 m²
...
**Exception**: indeterminate growth -- never stops growing throughout life, unusual among the game's reptiles. High-value CC species despite Least Concern status: up to ~1,000 CC/breeding-pair cycle, ~2,000 CC/5 in-game years with strong longevity/fertility genetics -- a real example of genetics/breeding efficiency outweighing IUCN status in the CC payout formula (see `mechanics.md` Conservation & Research).
