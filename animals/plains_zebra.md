# Animals -- Plains Zebra

**status:** research-integrated
**last_reconciled:** 2026-08-22

**Latin:** *Equus quagga* | **Continent:** Africa | **IUCN (in-game):** Near Threatened | **Housing type:** Habitat

## Housing & environment

- **Land min / +per adult:** 510 m² / +180 m²
- **Water min:** 0 m²
- **Climb min:** 0 m²
- **Temperature range:** 8-40 degC
- **Biome:** Grassland
- **Terrain composition:** grass 20-100% / soil 0-40% / rock 0-40% / sand 0-30% / snow 0%
...
- **Social type / group:** Harem herds + bachelor herds; 3-6
- **Mixing compatibility:** African Buffalo, both Wildebeest, Ostrich, Warthog, Giraffe, Sable, Scimitar Oryx, S. White Rhino, Springbok, Thomson's Gazelle
...
Sleeps standing up; posts "watches" during sleep for predators. The only base-game zebra species (Grevy's Zebra does not exist in Planet Zoo -- do not confuse when a player mentions it).
