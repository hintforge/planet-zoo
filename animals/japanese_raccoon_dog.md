# Animals -- Japanese Raccoon Dog

**status:** research-integrated
**last_reconciled:** 2026-08-22

**Continent (real-world range):** Asia -- endemic to Japan (introduced NE Europe too) | **Real IUCN status:** Least Concern | **Housing type:** Habitat
...
- **Land min / +per adult:** 210 m² / +20 m² `[planetzoohelper 2026-09-17]`
- **Water min:** 0 m² `[planetzoohelper 2026-09-17]`
- **Climb min:** 15 m² `[planetzoohelper 2026-09-17]`
- **Temperature range:** -4-31 degC `[planetzoohelper 2026-09-17]`
- **Biome(s):** Temperate `[planetzoohelper 2026-09-17]`
- **Terrain composition:** grass 20-100% / soil 10-60% / rock 0-20% / sand 0-10% / snow 0-100% `[planetzoohelper 2026-09-17]`
...
- **Native range:** Japan (endemic, the tanuki); introduced/established in northeastern Europe
- **Real diet:** Omnivore -- fruits, berries, agricultural crops
- **Natural social structure:** Monogamous breeding pairs; unpaired individuals may group until mated

## Pack note

This pack's new career scenario features a companion character named "Nugget," a Japanese raccoon dog -- narrative detail, not a mechanical fact.

_source: Planet Zoo DLC research pass (P3) 2026-08-22, Wikipedia species page · capture: web_fetch · confidence: medium (real-world biology only; in-game welfare data NOT obtained) · enemy-tier: 0 · puzzle-tier: 0 · category: mainline · spoiler: dlc:Asia Animal Pack_

## Sources
- store.steampowered.com [official-pr, DLC listing]
- en.wikipedia.org/wiki/Japanese_raccoon_dog [editorial-en]
