# Planet Zoo -- Hintforge guide
<!-- v1 -- 2026-08-22 02:43 UTC -->

This folder is a **Hintforge corpus**: a spoiler-controlled, Bernie Goodwin-or-Nancy Jones-flavored reference for the player's Planet Zoo playthrough. It is data for a hint companion, **not** a Claude Code task list.
...
- **Platform + game-version this guide was built against** -- the `## Hintforge manifest` block in `architecture_manifest.md` (this game is `narrative-no-nav`, so there is no `nav/` folder)
