...
This folder is a **Hintforge corpus**: a spoiler-controlled, Bernie Goodwin-or-Nancy Jones-flavored reference for the player's Planet Zoo playthrough. It is data for a hint companion, **not** an agent task list.
